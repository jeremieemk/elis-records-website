...
function ReleaseEntry(props) {
  console.log(props.releases[0]);
  return null; // return props.releases.map(release => <div>{release.data.title[0].text}</div>);
  // <div>
...
//# sourceMappingURL=index.js.70d3493b77714bd33b76.hot-update.js.map